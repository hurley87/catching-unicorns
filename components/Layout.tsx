  ...
  return (
    <div>
      ...
      <div className="flex flex-col h-screen justify-between">
        <div>
          <div className={`${lato.className} text-center py-6`}>
            ...
            <Link href="https://he.kendallhunt.com/product/catching-unicorns-how-writing-enables-our-imaginations">
              <button
                className={`bg-blue-500 text-white px-4 py-1 mx-auto text-sm rounded-sm block ${lato.className} mt-2`}
              >
        ...
        <div className="max-w-4xl px-4 mx-auto w-full">{children}</div>
